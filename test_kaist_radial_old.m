...
% OLD VERSION: This means this does the update in radial space, when it should actually be in radial space.
%
%   Charles Guan
%
...
ks = {radial_sampling_mask_2readout_lines_k, radial_sampling_mask_4readout_lines_k, radial_sampling_mask_8readout_lines_k, radial_sampling_mask_16readout_lines_k, radial_sampling_mask_32readout_lines_k, radial_sampling_mask_64readout_lines_k};
wis = {radial_sampling_mask_2readout_lines_wi, radial_sampling_mask_4readout_lines_wi, radial_sampling_mask_8readout_lines_wi, radial_sampling_mask_16readout_lines_wi, radial_sampling_mask_32readout_lines_wi, radial_sampling_mask_64readout_lines_wi};
...
for idx = 3:numel(nls)
    ...
    wi = wi_max;
    nl = nl_max;
    disp(sprintf('Running radial recon with %d radial lines', nls(idx)));
